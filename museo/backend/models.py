# models.py
# Modelos SQLAlchemy para el sistema del Museo Pumapungo
# Universidad Politécnica Salesiana - Versión Simplificada
...
class ItinerarioDetalle(Base):
    ...
    puntos_clave = Column(ARRAY(Text))  # ['Cerámica Cañari', 'Herramientas']
