...
async def google_callback(
    ...
    """
    Callback de Google OAuth
    ✅ MODIFICADO: Ahora verifica si el visitante tiene datos completos
    """
    ...
    try:
        ...
        # 6. ✅ REDIRIGIR AL FRONTEND con los datos + bandera de datos_completos
        settings = get_settings()
        frontend_url = settings.FRONTEND_URL or "http://localhost:5173"
        ...
        params = {
            ...
            "email": visitante.email,
            "success": "true",
            "datos_completos": "true" if datos_completos else "false"  # ✅ NUEVO
        }
